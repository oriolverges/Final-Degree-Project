...
from Dataset import EmbeddingsAndSequences, get_labels
...
def main(args):
    ...
    mlp.eval()
    with torch.no_grad():
        for batch_combined_embeddings in test_loader:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--codonBERT_train", type=str, help="Path of the CodonBERT weight file prefix.")
    parser.add_argument("--esm_dir_train", type=str, help="Base directory containing ESM-1b files for training.")
    ...
    parser.add_argument("--codonBERT_test", type=str, help="Path of the CodonBERT weight file prefix for testing.")
    parser.add_argument("--esm_dir_test", type=str, help="Base directory containing ESM-1b files for testing.")
